...
export const FORM_PLACEHOLDERS = {
  profile: {
    companyName: 'نام کامل شرکت یا تعاونی',
    unitName: 'نام واحد، مزرعه یا کارگاه',
    unitType: 'شرکتی / صنفی / تعاونی / ...',
    guildCode: 'کد صنفی',
    ...
    producedGoods: 'گندم، ذرت، سیب، گوجه‌فرنگی',
    productIdNumber: 'AGR-10021',
    activityType: 'تولید کشاورزی و صادرات',
    description: 'خلاصه‌ای از فعالیت کشاورزی، محصولات اصلی و تجربه صادراتی',
  },
  ...
  product: {
    ...
    hsCode: '1001100000',
    grade: 'A / درجه ۱ / Premium',
    isicCode: '0111',
    serviceCode: 'AGR-001',
    countryOfOrigin: 'ایران / قزاقستان / ...',
    standardNumber: 'ISIRI 3103 / GlobalG.A.P.',
    minOrderQuantity: '۱۰۰ تن',
    deliveryLocation: 'بندر شهید رجایی / انبار اصفهان',
    advancePercent: '۳۰',
    onDeliveryPercent: '۷۰',
  },

  trade: {
    productNameFa: 'گندم مرغوب',
    serviceCode: 'AGR-1001',
    quantity: '100',
    quantityUnit: 'تن',
    targetMarket: 'عراق، افغانستان، پاکستان',
    supplySourceName: 'تعاونی کشاورزی / مزرعه نمونه',
    subject: 'بررسی بازار صادراتی گندم و غلات',
  },
};
